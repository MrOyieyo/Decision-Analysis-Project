---
title: "DRIP IRRIGATION ADOPTION IN MWEA IRRIGATON SCHEME-KENYA."
author: "Adrian, Aparna, Silas, Steven"
date: "2023-07-12"
output:
...
Demand for more reliable food sources, continuous depletion of natural resources and climate change due to anthropogenic factors have become a point of concern. It is from this background that many governments around the world set up irrigation schemes to enhance food and nutrition security, and improve livelihoods in rural areas. (@mati_farmer-led_2023)

Kenya has a great potential to increase food production to get liberated from seasonal agricultural dependency through investing in more water efficient agricultural technologies to improve yields and subsequently rural development.(@kanda_status_2022)

Around 80% (Strategic-Plan-Final) of the national irrigation schemes are still under surface irrigation system like; farrow, boarder, flood methods of irrigation. This leads to wastage of water resources, depletion of  ground  Water, and uneven distribution of water in the fields.Oftentimes water is wasted as the amount supplied to certain crops (vegetable and cereals) at a particular time is more than what they can taken in. As a result, leaching of fertilizers, growth of weeds, and in some cases rotting of plants due to too much water hence less water use efficiency. Moving forward, efficient water management strategies should become a priority. (@holting_including_2020)
...
Sustainability is Key and the authors firmly believe that adoption of Drip Irrigation technology which is a proved and improved strategy in arid countries like Israel and elsewhere as a water saving technique if put to use in the production of cereals and vegetables in Mwea Irrigation Scheme by the government of Kenya, it would go a long way in achieving water use efficiency to increase food production, replenishing the ground water reserves, Biodiversity restoration, promotion of tourism as the National Parks up stream will also benefit from the water which remains in the landscape.  
...
We conducted a Stakeholder Analysis to gain a deeper understanding of who the various stakeholders are in Mwea Irrigation scheme at the various levels of the project implementation. This also enabled us to generate the Conceptual Model and the Impact Pathways which depict the sequence of events that lead to the adoption of the project. Expert Calibration was done to generate estimates which enabled us to generate a simple and a complex Model which were built using R programme Packages like; decisionsupport() and tidyverse(). The Assessment was done using functions like Net Present Value (NPV). visualization was through the use of plot_cashflow() and compound_figure() functions.
...
# Decision Maker
All interventions and development works in a country are implemented by government or on behalf of the government or in partnership with government. Therefore, Government of Kenya is the targeted implementer of the project. All the policies we hope to be considered are designed and and amended by the government @holting_including_2020. 


# Stakeholders Analysis 
 A stakeholder is an individual/group/item with interests that can affect or is affected by the decision of the project.In the scheme there are many stakeholders and the majority were considered with a view of precisely identifying the Key categories affecting and being affected by the decision.
...
For the purpose of analysis and defining most important stakeholders and the decision maker
...
# Project Evaluation
Before investing into the project, pre-calculations to assess the viability of the project is needed. Project installation and setup cost against profits generated over time has to be evaluated.

Rain fed irrigation in Kenya follow a simple evaluation process which is rarely undertaken by the farmers.
...
# Conceptual model
This Framework illustrates the contributions and effects of all the uncertainties, assumptions, benefits and negative consequences resulting from the project while considering both short and long term benefits and general cost for the project.
...
Benefits
Considering the option of Drip Irrigation, benefits were categorized depending on the period they would be achieved. Short-term (ie. the benefits that are immediately realized a few months (6-12 months) after the installation of the technology) for example; Increase in yields, enhanced water use efficiency, reduction in farmer operational costs as hired labor gets low and reduced weeding intervals thus increasing farmer savings. These were mainly Benefits to Farmers (BFT). The other category is Long-term (ie. benefits achieved above one year, these are basically benefits to both the government and farmers (BTGF) these include; increase in incomes and standards of living, better nutrition, increase in Hydro Power generation ( a big earner to government) as a result of reduction in water diversion from the Pekera and Nyamindi rivers into the scheme, enhancement in tourism due to enhanced water management in the landscape to support biodiversity and National Parks (Mwea National Reserve), and lastly improvement in Landscape and Ecosystem.
...
During the calibration training, the authors gained skills in providing expert estimates on the various required variables from the conceptual model.These were provided based on literature, gut feeling, individual experiences and verification with the author who comes from the Kenya.
...
To be able to evaluate the Net Present Value of all the decision option, we used the Discount rate of 8.0% (lower) and 12.0% (upper) which is widely recommended by the World Bank and International Development Cooperation as a standard for evaluating public investments in Developing Countries.

Due to the certainty in the area of study about the prevalence of drought, we also considered the drought estimates in the table to be around 10.0% (lower) and 20.0% (upper)
...
A simple primary model was developed under the code below to give us a sneak peak into how the pathways behave with the estimates. We used the data.frame() function to generate the estimates. An independent model function for each decision option was developed and the plot distributions were generated using mcSimulation() function from the decisionSupport library with 800 runs for each option.
```{r echo=FALSE}
#### DRIP IRRIGATION ####
#Building the model
...
Drip Irrigation.
The distribution indicated a lot of uncertainties in the outcomes as it was widely spread out but with a few figures in the negative and majority on the positive side upto 500KSh. (in 1,000Ksh.) 

Surface Irrigation.
The distribution was evenly spread out with far less outcomes compared to Drip irrigation about 45 KSh (in 1,000 Ksh)


##Shortfalls of the simple model.
The simple model was overly simplified because the following important aspects were not considered.

1. The estimates were not being fetched from the same estimate table.

2. Each decision option had its own model function, this limited the mcSimulation results to be subjected to the same environment.

3. Separating the distribution plots doesn't allow you chance to properly assess the results on how the distributions shade (over rap) each other.

4. It never considered important factors for decision analysis in the context of the Irrigation scheme like; NPV, Discount rate, number of years for the assessment, and varying of the installation costs to only run  for the first year.

Note: All these shortfalls made the simple model so unrealistic to be used in decision making.

# Model Upgrade
To improve the assessment for a better decision option, we addressed the shortfalls for the simple model by;

1. Joining the estimates to have one csv. table of estimates.

2. Combining both decision options to be run in one code-block

3. The time frame for the project was set to 5 years as the timeline considered to have generated enough income to offset the cost of Drip Irrigation system installation.

4. The Installation costs for both decision options were made to run for only the first year of the project implementation. 

5. The distributions were plotted and analysed together for both decision options. 

6. We introduced the vv() function from the decisionSupport library because many of our considered variables vary over time. This variation in time series analyses enabled us to have a clear output of the variables considering a desired coefficient of variation of 5.0% (lower) and 20.0% (upper). 

7. Also the chance_event() function from the decisionSupport library was introduced that took into account the drought event occurrence with in our simulations. The estimates used were 10.0% (lower) and 30.0% (upper).

8. Better decision assessment functions were introduced to visualize the outcomes for proper analysis to facilitate decision making. These include;
   
   a) plot_distributions()function from decisionSupport library to show the full results of Monte Carlo model with the expected NPV considering if the government implemented the project or not. The boxplots with median was added to compare the outcomes of both decision options with their outliers.
   
   b) plot_cashflow() function from decisionSupport library to show the cashflow analysis distribution of the cashflow for the 5 years of the project assessment using the specific cashflows indicted from the mcSimulation() using cashflow_decision_Surface/Drip.
   
   c) compound_figure() function from the decisionSupport library to show single figure outputs for assessment. This analysis was to help in decision making if to take-up the project or not as well as indicating the most important variables.
   
## Model without Drought
We wanted to simulate the outcomes of the project under normal conditions (rain) to assess if it is justifiable to invest in the expensive technology. This was achieved with the chance_event() function while setting the value_if to 0, and Value_if_not to 0, for the 5 years of the assessment.
````{r echo=FALSE}
...
irrigation_model_function_withoutDrought<-function(x){
  ...
  for (decision_drip_irrigation in c(FALSE,TRUE)){
    ...
    if (decision_drip_irrigation){
      ...
      # Costs ####
       # function to explicitly run the establishment cost only in the first year
...
#### plot_distribution() function results
The distribution of the expected NPV of Drip irrigation showed high certainty due to the peakness of the plots and with more benefits while the surface irrigation decision option distribution of expected NPV showed more uncertainties and less outcomes.
The boxplot display a graphical representation of the outcomes from both decision options with the median line and outliers. The Drip Irrigation option had more better outcomes with outliers on one side.

#### plot_cashflow() function results
The distributions from the cashflows for the 5 years of the Drip Irrigation decision option assessment had a median outcome rising very fast in the 2 years of the project implementation afterwards, it started varying but far higher than the median of surface Irrigation decision option.
The median of the surface Irrigation decision option slightly rose in the first 3 years of implementation and it somehow leveled off during the 5 year period of assessment.

#### compound_figure() function results
To explicitly have a clear understanding of the decision option outcomes, we generated the single figure from all variables.

Drip Irrigation decision option had Yields, All other earnings and management_savings as positive values with All other earnings and Yields variables above the threshold indicating that they are very important inputs to consider in the assessment model. The Installation costs negatively impact the outcomes but it is very important to consider as it has a great value of information to determine the decision option.
...
## Model with Drought
After assessing the results in normal conditions with no drought, we wanted to see if the project was still profitable in the much anticipated climate change with the occurrence of drought. This was achieved with the chance_event() function while setting the value_if to 1, and Value_if_not to 0, for the 5 years of the assessment.
...
#### plot_distribution() function results
The distribution of the expected NPV of surface irrigation showed high certainty due to the peakness of the plots but with less outcomes unto around 1,700 KSh (in 1,000 KSh) while the drip irrigation decision option distribution of expected NPV showed more uncertainties but with more positive outcomes above 2,000KSh (in 1,000KSh).
The boxplot display a graphical representation of the outcomes from both decision options with the median line and outliers. The Drip Irrigation option had more better outcomes with outliers on both sides indicating a high level of uncertainties.

#### plot_cashflow() function results
The distributions from the cashflows for the 5 years of the Drip Irrigation decision option assessment had a median outcome rising very fast in the first year of the project implementation afterwards, it started varying but far higher than the median of surface Irrigation decision option.
The median of the surface Irrigation decision option slightly rose in the first 2 years of implementation and it somehow leveled off during the 5 year period of assessment.

#### compound_figure() function results
To explicitly have a clear understanding of the decision option outcomes, we generated the single figure from all variables.

Drip Irrigation decision option had Yields, All other earnings and management_savings as positive values with All other earnings and Yields variables above the threshold indicating that they are very important inputs to consider in the assessment model. Installation costs were negative as they reduce the our outcomes.
...
# Recomendations
- Government of Kenya should consider drip irrigation over the conventional surface irrigation in vegetable and cereal production plots of Mwea Irrigation Scheme. 
- Without Drought, the Installation cost variable should be limited as it is positively significant and greatly impacts the outcomes.
- The  benefits  due to the adoption of Irrigation systems are  much more leading to an improvement in vegetable and cereal  productivity,  water  use efficiency and promotion of Eco_systems' balance.


# What the authors learnt
...
- Integrating the different conventional methodologies and computer based models limits human biases that can affect the outcomes of a decision making or forecasting model. This offers clear insights into forecasting for better decision making processes (from Optimistic Skeptic).
- R Programming language,  more insight on the language and its packages, it's application and importance in research. 
- We live in fast-changing world, this requires to continuously update our thoughts, perspectives and the decisions we make. Very often, we are faced with uncertainties due to lack of data to make informed and appropriate  decisions when required. Banking on literature, expert knowledge and analysis coupled with various R programming packages are handy in developing and supporting the decision making process with less biases.

# References
1. The  status  and  challenges  of  a  modern  irrigation  system  in  Kenya:  A systematic review
2. The  social  discount  rate  in  the  evaluation  of  investment  projects:  an application for Ecuador:
3. Farmer-led  irrigation  development  in  Kenya:  Characteristics  and opportunities:
4. Strengthening  agricultural  water  efficiency  and  productivity  on  the African and global level
