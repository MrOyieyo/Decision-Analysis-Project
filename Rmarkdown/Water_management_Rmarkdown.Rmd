...
<<<<<<< HEAD
bibliography: References/reference_item.bib
=======
>>>>>>> d4cdec93f74564062eb0fad2f1c4c41069531e9e
---
...
## Description for the project Evaluation
...
To be able to evaluate the Net Present Value of all the decision option, we used the Discount rate of 8.0% (lower) and 12.0% (upper) which is widely recommended by the World Bank and International Development Cooperations as a standard for evaluating public investments in Developing Countries (readdddddddddpaperrrrrrrr)
