...
```{r echo=FALSE}
knitr::include_graphics("https://github.com/MrOyieyo/Decision-Analysis-Project/blob/main/Figures/current_evaluation.png?raw=true")
...
knitr::include_graphics("https://github.com/MrOyieyo/Decision-Analysis-Project/blob/main/Figures/Conceptual%20model.png?raw=true")
```
...
knitr::include_graphics("https://github.com/MrOyieyo/Decision-Analysis-Project/blob/main/Figures/Impactpath_Rplot.png?raw=true")
...
knitr::include_graphics("https://github.com/MrOyieyo/Decision-Analysis-Project/blob/main/Figures/impact_path_way.png?raw=true")
```
...
```{r echo=FALSE}
#with drought
("Figures/with%20drought-Rplotdistribution.png")

knitr::include_graphics("https://github.com/MrOyieyo/Decision-Analysis-Project/blob/main/Figures/with%20drought%20-%20drip%20compound%20figure.png?raw=true")
# explanation of the graphs and pattern flow.


#surface irrigation
knitr::include_graphics("https://github.com/MrOyieyo/Decision-Analysis-Project/blob/main/Figures/with%20drougth%20-%20surface%20irrigation%20compounding%20figure.png?raw=true")
