...
<<<<<<< HEAD
```{r echo=FALSE}
data_stakeholder <- "https://github.com/MrOyieyo/Decision-Analysis-Project/blob/main/Stakeholders/Stakeholder%20Management%20data.csv"
stakeholder <- read_csv(url(data_stakeholder))
...
ggplot(data = stakeholder, aes(x = Expertise, 
  ...
  geom_hline(yintercept=2.5, color="white", linewidth=2) +
  geom_vline(xintercept=2.5, color="white", linewidth=2) +
...
```{r echo=FALSE}
knitr::include_graphics("C:/Users/oyiey/OneDrive/Dokumente/UniBonn SS2023/DecisionAnalysis/Decision-Analysis-Project/Decision-Analysis-Project/Figures/current_evaluation.png")
#https://github.com/MrOyieyo/Decision-Analysis-Project/blob/main/Figures
...
knitr::include_graphics("C:/Users/oyiey/OneDrive/Dokumente/UniBonn SS2023/DecisionAnalysis/Decision-Analysis-Project/Decision-Analysis-Project/Figures/Conceptual model.png")
#https://github.com/MrOyieyo/Decision-Analysis-Project/blob/main/Figures/Conceptual%20model.png
```
The general flow of the evaluation of the project model is as below.
```{r echo=FALSE, paged.print=TRUE}

knitr::include_graphics("C:/Users/oyiey/OneDrive/Dokumente/UniBonn SS2023/DecisionAnalysis/Decision-Analysis-Project/Decision-Analysis-Project/Figures/Impactpath_Rplot.png")
#https://github.com/MrOyieyo/Decision-Analysis-Project/blob/main/Figures/Impactpath_Rplot.png
```

#Impact Pathway
```{r echo=FALSE}

knitr::include_graphics("C:/Users/oyiey/OneDrive/Dokumente/UniBonn SS2023/DecisionAnalysis/Decision-Analysis-Project/Decision-Analysis-Project/Figures/impact_path_way.png")
#https://github.com/MrOyieyo/Decision-Analysis-Project/blob/main/Figures
```
#Estimates
...
```{r echo=FALSE}
urlfile = "https://github.com/MrOyieyo/Decision-Analysis-Project/blob/main/Model%20Function/Estimates.csv" 
Estimates = read_csv(url(urlfile))
...
# Estimates table
datatable <- "https://github.com/MrOyieyo/Decision-Analysis-Project/blob/main/Model%20Function/Estimates.csv"
...
mcSimulation_results_withDrought <- decisionSupport::mcSimulation(
  estimate = decisionSupport::estimate_read_csv("C:/Users/oyiey/OneDrive/Dokumente/UniBonn SS2023/DecisionAnalysis/Decision-Analysis-Project/Decision-Analysis-Project/Model Function/Estimates.csv"),
...
knitr::include_graphics("Figures/with drought - drip compound figure.png")
# explanation of the graphs and pattern flow.


#surface irrigation
knitr::include_graphics("Figures/with drougth - surface irrigation compounding figure.png")
