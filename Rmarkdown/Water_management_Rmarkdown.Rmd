...
```{r echo=FALSE}
knitr::include_graphics('https://github.com/MrOyieyo/Decision-Analysis-Project/blob/0dece34a90de301283d8fbf29d98de4804ac16ef/Figures/current_evaluation.png')
...
knitr::include_graphics("https://github.com/MrOyieyo/Decision-Analysis-Project/blob/0dece34a90de301283d8fbf29d98de4804ac16ef/Figures/Conceptual%20model.png")
```
The general flow of the evaluation of the project model is as below.
```{r echo=FALSE}

knitr::include_graphics("https://github.com/MrOyieyo/Decision-Analysis-Project/blob/0dece34a90de301283d8fbf29d98de4804ac16ef/Figures/Impactpath_Rplot.png")
```

#Impact Pathway
```{r echo=FALSE}
#dripIrr_path<-load.image("Figures/Impactpath_Rplot.png")
#plot(dripIrr_path, axes=FALSE)

knitr::include_graphics("https://github.com/MrOyieyo/Decision-Analysis-Project/blob/0dece34a90de301283d8fbf29d98de4804ac16ef/Figures/impact_path_way.png")
```
#Estimates
...
```{r echo=FALSE}
#with drought
knitr::include_graphics("Figures/with drought-Rplotdistribution.png")
