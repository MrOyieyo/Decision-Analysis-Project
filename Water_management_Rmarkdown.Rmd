...
stakeholder<-read.csv("https://raw.githubusercontent.com/MrOyieyo/Decision-Analysis-Project/main/Stakeholder%20Management%20data.csv")
...
```{r}
library(imager)
Conceptual_model <- load.image("https://github.com/MrOyieyo/Decision-Analysis-Project/blob/fb180332d940b7e317850d51f5255d2f41b2e3b0/Conceptual%20model.png")
...
input_table<-read_csv(url(url_table))
View(input_table)
​
# Model function ####
