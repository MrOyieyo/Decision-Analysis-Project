...
stakeholder<-Stakeholder_Management_data <- read.csv("https://raw.githubusercontent.com/MrOyieyo/Decision-Analysis-Project/main/Stakeholder%20Management%20data.csv") 
